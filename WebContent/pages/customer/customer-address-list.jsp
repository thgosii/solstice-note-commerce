    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="#" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light">Meus Endereços | LapTop Computadores</span>
        </a>
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <a href="/note-commerce/pages/customer/customer-address-new.jsp" class="float-sm-right"><strong>+</strong> Novo endereço</a>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </div>
          ...
          <table class="table table-striped">
			...
			<tbody>
				<c:forEach var="address" items="${requestScope.adresses}" varStatus="loop">
					<div class="modal fade" id="removeModal_${address.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
